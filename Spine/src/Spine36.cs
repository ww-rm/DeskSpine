...
namespace Spine
{
    internal class Spine36 : Spine
    {
        ...
        public override SpineVersion Version { get => SpineVersion.V36; }

        public Spine36(string skelPath, string? atlasPath = null, float defaultMix = 0) : base(skelPath, atlasPath)
        {
